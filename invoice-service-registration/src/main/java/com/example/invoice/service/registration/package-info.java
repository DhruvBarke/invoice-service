 ...
 * business-scoped set of {@link com.example.invoice.service.registration.rule.ValidationRule}s,
 ...
 * <ul>
 *   <li>{@link com.example.invoice.service.registration.Business} — add a new enum value.</li>
 *   <li>{@link com.example.invoice.service.registration.rule.ValidationRule} — implement,
 *       register in {@link com.example.invoice.service.registration.rule.ValidationRegistry}.</li>
 *   <li>{@link com.example.invoice.service.registration.error.ErrorCode} — add a value with its
